...
\newcommand{\TRGPPFG}[2]{\Pi^{(#1)}_{#2, \mathrm{tame}}}
\newcommand{\TRIGPPFG}[2]{\Pi^{(#1)}_{#2, \mathrm{t. iner.}}}
\newcommand{\lTA}[1]{G_{#1, \ell\text{-tame}}}
\newcommand{\lTRGPPFG}[2]{\Pi^{(#1)}_{#2, \ell\text{-tame}}}
\newcommand{\IPPFG}[2]{\Pi^{#1}_{#2, \text{iner.}}}

\newcommand{\ur}{\mathrm{ur}}
\newcommand{\Gal}{\mathrm{Gal}}

\newcommand{\IPRDG}[2]{D^{#1}_{#2}}